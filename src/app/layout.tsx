...
const GOOGLE_ANALYTICS_ID = "G-SVL3CWLJZF";
const GOOGLE_TAG_MANAGER_ID = "GTM-T2MDR4W";
const MICROSOFT_CLARITY_ID = "qu4xyuprxg";
...
export const metadata: Metadata = {
   ...
   * Do not add a separate <meta> tag inside the body.
   */
  verification: {
    google:
      "5l6_w1IFbXbp4Kzr9B2ePstAEiWwz_WZGYdfLz8AX6w",
  ...
  return (
    <html lang="en">
      ...
      >
         ...
         * Keep this immediately after the opening body tag.
         */}
        <noscript>
          <iframe
        ...
        {/* Direct Google Analytics GA4 library */}
        <Script
        ...
        {/* Direct Google Analytics GA4 configuration */}
        <Script
